...
public class FunctionLibrary {
	...
	public static void startTesting() throws Exception {
		...
		ReportUtil
				.startTesting(
						path
								+ utils.TestConstants.TESTREPORT_RESULT_DIR_PATH,
	...
	public static void emailStartTesting() throws Exception {
		...
		EmailReportUtil
				.startTesting(
						path
								+ utils.TestConstants.EMAIL_TESTREPORT_RESULT_DIR_PATH,
						TestUtil.now("dd.MMMMM.yyyy hh.mm.ss aaa"),
						EMAIL.getProperty("Env"), EMAIL.getProperty("Version"));
	}
	 ...
	 ***********************************************************************************************************/
	public boolean verifyText(String keyword, String keywordtype, String object,
			String objectProp) throws Exception {
		boolean veryTxt = false;
		// comparision Object
		String expData = V.getProperty(objectProp);
		Keywords keywords = new Keywords();
		TestConstants tc = keywords.actionElement(keyword, keywordtype, object,
				objectProp);
	...
	public String isDisplayed(String keyword, String keywordtype,
			String object, String objectProp) throws Exception {
	...
	public String isSelected(String keyword, String keywordtype, String object,
			String objectProp) throws Exception {
	...
	public String isEnabled(String keyword, String keywordtype, String object,
			String objectProp) throws Exception {
	 ...
	 ***********************************************************************************************************/
	public String compairText(String keyword, String keywordtype,
			String object, String objectProp) throws Exception {
		...
		TestConstants tc = keywords.actionElement(keyword, keywordtype, object,
				objectProp);
		wb1 = tc.welement;
		TestConstants tc1 = keywords.actionElement(keyword, keywordtype,
				object, objectProp);
		wb2 = tc1.welement;
	 ...
	 * Created Date : 10-Oct-2013 Updated by : Santhosh R LastUpdated :
	 ***********************************************************************************************************/
	public void mainReport(String keyword, String result,
			String fileName) {
	...
	public void report(String result, String stepDescription, String keyword,
		...
		case "Fail":
			...
			TestUtil.takeScreenShot(path
					+ utils.TestConstants.TESTSUITE_RESULT_DIR_PATH
					+ fileName);
	 ...
	 * R Created Date : 10-Oct-2013 Updated by : Santhosh R LastUpdated :
	 ***********************************************************************************************************/
	public void reportEmailMain(String result, String fileName,
	...
	public void autoIT(String pathFile) throws Exception {
		Runtime.getRuntime().exec(path + TestConstants.AUTOIT_PATH + pathFile);
	}
	...
	public int webTable(String object) {
		 ...
		 */
		/*
		 * for (int i = 3; i <= rCount; i++) { String
		 * txt=driver.findElement(By.xpath
		 * ("//*[@id='availabilityTable0']/tbody/tr["+i+"]")).getText();
		 * System.out.println("table values---"+txt); } int Scount = (int)
		 * (3+(Math.random()*(6- 3)));
		 * System.out.println("random value---"+Scount);
		 * driver.findElement(By.xpath
		 * ("//*[@id='availabilityTable0']/tbody/tr["+
		 * Scount+"]/td[5]/p/input")).click();
		 * System.out.println("random value---"+Scount);
		 */
		return rCount - 1;
	}
	...
	public static String getAttributeValue(String keyword, String keywordtype,
			String object, String objectProp) throws Exception {
		String expData = V.getProperty(objectProp);
		String veryTxt = null;
		Keywords keywords = new Keywords();
	...
	public static String getAttributeAlt(String keyword, String keywordtype,
			String object, String objectProp) throws Exception {
		String expData = V.getProperty(objectProp);
		String veryTxt = null;
		Keywords keywords = new Keywords();
	...
	public String verifyPageTitle(String keyword, String keywordtype,
			String object, String objectProp) throws Exception {
		String veryTxt = null;
		String expData = V.getProperty(objectProp);
	...
	public int editErroMeassages(String object, String data, int colom,
			int row, String tdshetnum) throws Exception {
		...
		for (int i = tableCount - 1; i >= 1; i--) {
			...
			if (erroMSG.equals(data)) {
				...
				System.out.println("ErroMessage value is======>"
						+ "//*[@id='error_message_" + i + "']");

				driver.findElement(
						By.xpath("//*[@id='error_message_" + i + "']")).clear();
				Thread.sleep(2000);
				driver.findElement(
						By.xpath("//*[@id='error_message_" + i + "']"))
						.sendKeys(data);
				Thread.sleep(5000);
				driver.findElement(
						By.xpath("//*[@id='error_message_" + i + "']"))
				...
				Thread.sleep(10000);
				driver.findElement(
						By.xpath("//*[@id='error_details']/table/tbody/tr[" + i
								+ "]/td[4]/a/img")).click();
	...
	public String verifyingErroMeassages(String object, String actual,
			int colom, int row, String tdshetnum) throws Exception {
		String result = null;
		int tableCount = driver.findElements(By.xpath(object)).size();
		System.out.println("table count=============>>>" + tableCount);
		for (int i = tableCount - 1; i >= 1; i--) {
			...
			if (erroMSG.equals(actual)) {
				...
				colom++;
				WebElement actualData = driver.findElement(By
						.xpath("//*[@id='error_message_" + i + "']"));
	...
	public void Appium() throws Exception{
		...
		FileInputStream fi = new FileInputStream("Properties/android.properties");
		Properties prop = new Properties();
		prop.load(fi);
		
		DesiredCapabilities desiredCapabilities  = new DesiredCapabilities();
		desiredCapabilities.setCapability(MobileCapabilityType.PLATFORM_NAME, "Android");
		desiredCapabilities.setCapability(MobileCapabilityType.DEVICE_NAME,prop.getProperty("deviceID"));
		desiredCapabilities.setCapability("androidPackage", prop.getProperty("PackageName"));
		desiredCapabilities.setCapability("appActivity", prop.getProperty("LauncherActivity"));
...
public void Indexinput(String object, String data2){
	...
	System.out.println(b);
		...
		try{
			List<WebElement> textFieldsList = driver.findElements(By.className(OR.getProperty(object)));
	       textFieldsList.get(a).sendKeys(b);
	...
	public void Indexclick(String object, String data3){
		String testdata = data3;
		int a=Integer.valueOf(testdata);
		System.out.println(testdata);
		
		try{
			List<WebElement> button = driver.findElements(By.className(OR.getProperty(object)));
	        button.get(a).click();
...
try{
	...
	//String[] Tap = record.split(",");
	
	//int tapx=Integer.valueOf(Tap[0]);
	//int tapy=Integer.valueOf(Tap[1]);
	
	tapObject.put("x", (double) 100 ); // in pixels from left
	tapObject.put("y", (double) 200);
...
*/
	...
	public void waitForText() throws Exception {
		Calendar rightNow = Calendar.getInstance();
		boolean time = true;
		while (time) {
			Calendar rightNow1 = Calendar.getInstance();
			int newTime = rightNow1.get(Calendar.MINUTE);
			int oldTime = rightNow.get(Calendar.MINUTE) + 1;
			if (oldTime == 60) {
				System.out.println("am in oldTime");
				oldTime = 0;
			}
			/**
			 * Wating 1min for loading a page
			 */
			if (newTime == oldTime) {
				log.info("Page Load Start and End Time's are Equals");
				time = false;
				break;
			}
		}
