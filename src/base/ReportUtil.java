	...
	public static void startTesting(String filename,String testStartTime,String env,String rel)
	  {
	   ...
	   //  out.newLine();
	     ...
	     out.write("</table>\n");
	        ...
	        out.write("<table  border=1 cellspacing=1 cellpadding=1 >");
	    	out.write("<tr>");
	        out.write("<td width=300  align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Test Script#</b></td>");

	        out.write("<td width=300 align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Test Case Name</b></td>");
	        out.write("<td width=300 align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Status</b></td>");
	        out.write("<td width=300 align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Run Start Time</b></td>");
	        out.write("<td width=300 align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Run End Time</b></td>");
	        out.write("</tr>");
